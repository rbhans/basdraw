import { TldrawUiButton, TldrawUiButtonLabel, TldrawUiInput, useEditor } from 'tldraw'
...
import { BAS_TABLE_SHAPE_TYPE, type BasTableShape, type BasTrendShape } from './DataWidgetShapes'

export type DataShape = BasTableShape | BasTrendShape

export function DataShapeSettings({ shape }: { shape: DataShape }) {
